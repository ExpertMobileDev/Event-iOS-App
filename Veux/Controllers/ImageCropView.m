...
//  MaskView.m
//
//  Created by Jonas on 10/30/2015.
//
...
- (void)viewDidLoad
{
    ...
    if (self){
        ...
        UIButton* btnDone = [[UIButton alloc] initWithFrame:CGRectMake(195, view.size.height, 105, 40)];
        [btnDone setBackgroundColor:[UIColor colorWithRed:(float)233/255 green:(float)141/255 blue:(float)53/255 alpha:1.0]];
        [btnDone setTitle:@"Done" forState:UIControlStateNormal];
        btnDone.layer.cornerRadius = 5;
        btnDone.autoresizingMask = UIViewAutoresizingFlexibleBottomMargin;
        [btnDone addTarget:self action:@selector(done:) forControlEvents:UIControlEventTouchUpInside];
        [contentView addSubview:btnDone];

        UIButton* btnCancel = [[UIButton alloc] initWithFrame:CGRectMake(20, view.size.height, 105, 40)];
        [btnCancel setBackgroundColor:[UIColor colorWithRed:(float)233/255 green:(float)141/255 blue:(float)53/255 alpha:1.0]];
